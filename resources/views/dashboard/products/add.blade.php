...
@section('body')
    <main class="main">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('word.products') }}</a>
            </li>
            <li class="breadcrumb-item active">{{ __('word.add product') }}</li>

            <!-- Breadcrumb Menu-->
            <li class="breadcrumb-menu">
                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                    <a class="btn btn-secondary" href="#"><i class="icon-speech"></i></a>
                    <a class="btn btn-secondary" href="./"><i class="icon-graph"></i> &nbsp;{{ __('word.products') }}</a>
                    <a class="btn btn-secondary" href="#"><i class="icon-settings"></i> &nbsp;{{ __('word.add product') }}</a>
                </div>
            </li>
        </ol>
                                        ...
                                        @foreach (config('app.languages') as $key => $lang)
                                            <div class="tab-pane mt-3 fade @if ($loop->index == 0) show active in @endif"
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" name="{{ $key }}[price]" class="form-control" id="" />
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
