<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" href="index.html"><i class="icon-speedometer"></i> {{__('word.dashboard')}} <span class="tag tag-info">جدید</span></a>
            </li>
            ...
            <li class="nav-title">
             ...
             <li class="nav-item">
                <a class="nav-link" href="{{ route('dashboard.settings')}}"><i class="icon-docs"></i> لیست فایل ها</a>
            </li>
